...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-firstname']"), "Riya");
        //3.4 Enter Last Name
        sendTextToElement(By.xpath("//input[@id='input-lastname']"), "Patel");
        //3.5 Enter Email
        sendTextToElement(By.xpath("//input[@id='input-email']"), "reemexperts@gmail.com");
        //3.6 Enter Telephone
        sendTextToElement(By.xpath("//input[@id='input-telephone']"), "123456789");
        //3.7 Enter Password
        sendTextToElement(By.xpath("//input[@id='input-password']"), "riya123");
        //3.8 Enter Password Confirm
        sendTextToElement(By.xpath("//input[@id='input-confirm']"), "riya123");
