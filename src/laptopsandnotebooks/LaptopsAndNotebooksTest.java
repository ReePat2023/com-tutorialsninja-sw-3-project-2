...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException{
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Riya");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "Patel");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "reemexperts@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "123456789");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "xyz-lane");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "london");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"), "xyz123");
